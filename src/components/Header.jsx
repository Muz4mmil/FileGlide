  ...
  return (
    <div className="header animate__animated animate__fadeIn">
      ...
      <div className='header-card'>
        ...
        <button title='Install FileGLide on Your device for faster access' id="install-button" className='install-button' style={{ display: 'none' }}><i class="fa-solid fa-file-arrow-down"></i></button>
      </div>
